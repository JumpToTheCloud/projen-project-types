  ...
  describe('Basic Configuration', () => {
    test('should create a CDKTF library project with default options', () => {
      const options: CdktfLibraryOptions = {
        name: 'test-cdktf-library',
        author: 'test-author',
        authorAddress: 'test@example.com',
        repositoryUrl: 'https://github.com/test/test-cdktf-library.git',
  ...
  describe('JSII Configuration', () => {
    test('should configure JSII for multi-language support', () => {
      const options: CdktfLibraryOptions = {
        ...
        cdktfVersion: '^0.13.0',
        publishToPypi: {
          distName: 'test-cdktf-library',
          module: 'test_cdktf_library',
        },
        publishToMaven: {
          javaPackage: 'com.test.cdktflibrary',
          mavenGroupId: 'com.test',
          mavenArtifactId: 'test-cdktf-library',
        },
      };
